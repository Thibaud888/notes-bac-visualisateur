...
- [ ] Bouton « Réinitialiser la simulation » — remet notes/cadenas/libellés aux valeurs par défaut
...
- [ ] Meta Open Graph + Twitter Card dans `index.html` — titre, description, image (emoji 🎓 en
